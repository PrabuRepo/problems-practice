...
public class StringAPI {
	...
	public void stringFrequentlyUsedAPIs() {
		...
		/* equals Vs '==' : equals is preferable for string comparison; bcoz it compares values in the string; But == compares memory address*/
		String str3 = str;
		...
		System.out.println("indexOf substring from given index: " + str.indexOf("r", 1));
		...
		System.out.println("String to Char Array: " + array);
		System.out.println("Array to String: " + Arrays.toString(str.toCharArray())); //Array to String
		...
		System.out.println("split: " + split); // Split based on regex
	}
	...
	// Consolidated - TODO: Revisit and delete this . It looks like a duplicate
	...
	// StringBuilder Vs StringBuffer API: TODO
}